...
1.在 `my_db_01` 数据库中，新建 `ev_users` 表如下： 
 ...
 ![](C:\资料备份\学习笔记\01-Web笔记\101-Node.js\02-项目实战\media\2022-08-07_104255.png)
...
module.exports = routerCopy to clipboardErrorCopied
```
...
##### 4.1.1 创建表结构
 ...
 ![](C:\资料备份\学习笔记\01-Web笔记\101-Node.js\02-项目实战\media\2022-08-07_113938.png)

##### 4.1.2 新增两条初始数据

 ![](C:\资料备份\学习笔记\01-Web笔记\101-Node.js\02-项目实战\media\2022-08-07_114057.png)
...
```js
// 导入数据库操作模块
const db = require('../db/index')Copy to clipboardErrorCopied
```
...
const sql = 'select * from ev_article_cate where is_delete=0 order by id asc'Copy to clipboardErrorCopied
```
...
#### 5.1 新建 ev_articles 表
 ...
 ![](C:\资料备份\学习笔记\01-Web笔记\101-Node.js\02-项目实战\media\2022-08-07_144411.png)
